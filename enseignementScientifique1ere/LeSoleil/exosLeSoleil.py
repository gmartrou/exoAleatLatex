...
def tempEtoile(fileExercices, fileCorrections):
    main = r'''\titledquestion{Température d'une étoile : }
Dans les documents ci-après, les sept premiers graphiques donnent l'émission énergétique émise en fonction de la longueur d'onde (en \si{\nm}) pour des corpts noirs à différentes températures. Le huitième graphique représente irradiance spectrale en fonction de la longueur d'onde (en \si{\um}) de différentes étoiles.\\

\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/4k5k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/1k14k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/3k4k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/6k10k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/11k15k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/5k6k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/2k3k.pdf}\\
\includegraphics[width=\textwidth]{enseignementScientifique1ere/Mouvement/plankLaw/Stars.png}\\
...
À partir du huitième graphique, on remarque que la longueur d'onde correspondant au maximum d'intensité, $\lambda_{max}$, est d'environ $1,5~\si{\um}$, soit $\lambda_{max} \simeq \longueurOnde~\si{\nm}$.\\
...
\part[5] En utilisant la loi de Wien, calculer la température de l'étoile \etoile. Comparez ces deux valeurs. \textbf{Rappel : $k = 2,898 \times 10^{-3}~\si{\meter \kelvin}$}.\\
\begin{solutionordottedlines}[5cm]
On sait que $\lambda_{max} \simeq \longueurOnde~\si{\nm}$ et, d'après la loi de Wien $k = \lambda_{max} \times T$ que l'on peut aussi écrire $T = \dfrac{k}{\lambda_{max}} \simeq \dfrac{2,898 \times 10^{-3}~\si{\meter \kelvin}}{\longueurOnde~\si{\nm}} \simeq \dfrac{2,898 \times 10^{-3}~\si{\meter \kelvin}}{\longueurOnde \times 10^{-9}~\si{\meter}} \simeq 2415~\si{\kelvin}$. On a une valeur proche de ce que l'on a trouvé grâce au graphique.
\end{solutionordottedlines}
\end{parts}
'''